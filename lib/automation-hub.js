...
function buildTargetReference(artifact = {}, action = null) {
  ...
  if (type === 'provider_extraction_review') {
    ...
    return {
      ...
      openTargetLabel: refs.providerId && !pending ? 'Open target record' : 'Open provider review panel',
  ...
  if (type === 'provider_matching_results') {
    ...
    return {
      ...
      destinationUrl: targetUrl,
      openTargetLabel: status === 'confirmed' ? 'Open target record' : 'Open matching results',
