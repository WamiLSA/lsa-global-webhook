...
const OPERATOR_REFERENCE_LABELS = {
  ...
  'manual-kb-formatting-check': 'Manual knowledge formatting check',
  'manual-duplicate-check': 'Manual duplicate review check',
  'manual-inbox-helper-check': 'Manual inbox helper check',
  manual_service_intent_check: 'Manual service-intent check',
